...
function Card({
  ...
  const shell: React.CSSProperties = {
    ...
    borderRadius:16, padding:10, boxShadow:"0 2px 10px rgba(0,0,0,0.18)", marginTop:7
  };
  const bar: React.CSSProperties = {
    height:90, display:"flex", alignItems:"center", justifyContent:"center",
    borderRadius:12, background:bg, color:"#0b2540", fontWeight:900, fontSize:24, letterSpacing:0.3
  };
  const titleStyle: React.CSSProperties = { fontWeight:800, fontSize:16, marginBottom:7 };
